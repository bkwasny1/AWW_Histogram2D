...
const float Converter::parula[64][3] = {
...
void Converter::valueToParulaColor(float value, unsigned char& r, unsigned char& g, unsigned char& b)
{
    ...
    float r_f = (1 - t) * parula[idx][0] + t * parula[idx + 1][0];
    float g_f = (1 - t) * parula[idx][1] + t * parula[idx + 1][1];
    float b_f = (1 - t) * parula[idx][2] + t * parula[idx + 1][2];
